...
$lang = array_merge($lang, array(
	...
	'EXTENSION_DIR_INVALID'		=> 'La extensión seleccionada tiene una estructura de directorio no válido y no puede ser activado.',
	...
	'EXTENSION_ENABLE_EXPLAIN'		=> 'Habilitando una extensión, le permitira usarla en tu foro.',

	'EXTENSION_DELETE_DATA_IN_PROGRESS'	=> 'Actualmente se está borrando datos de la extensión. Por favor, no cambies de esta página o refresques hasta que se complete.',
	'EXTENSION_DISABLE_IN_PROGRESS'	=> 'Actualmente se está desactivando la extensión. Por favor, no cambies de esta página o refresques hasta que se complete.',
	'EXTENSION_ENABLE_IN_PROGRESS'	=> 'Actualmente se está activando la extensión. Por favor, no cambies de esta página o refresques hasta que se complete.',
    ...
    'EXTENSION_FORCE_UNSTABLE_CONFIRM'	=> '¿Estás seguro de querer forzar el uso de la versión inestable?',
